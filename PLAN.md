...
| Issue Type/Priority | `type` | `cacoo.primaryColor` | *Optional logic below* |
  ...
  "shapes": [
    {
      ...
      "cacoo": {
        "title": {
          "text": "${key}",
          "leading": 6,
          "styles": [{ "index": 0, "font": "Open Sans", "size": 14, "color": "333333", "bold": true }],
          "links": [],
          "height": 20
        },
        "description": {
          "text": "${summary}\n(担当: ${assignee})",
          "leading": 6,
          "styles": [{ "index": 0, "font": "Open Sans", "size": 12, "color": "333333" }],
          "links": [],
          "height": 18
        },
        "expanded": true,
